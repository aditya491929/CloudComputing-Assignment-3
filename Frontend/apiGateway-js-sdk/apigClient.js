...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            ...
            sessionToken: '',
            region: 'us-east-1',
            apiKey: "nQzoSePq7NosvCc3NiDYaWFHQZzptYN37c4kyGO7",
    ...
    var invokeUrl = 'https://46ggyeh9sg.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        var uploadBucketKeyPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'Accept', 'customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
